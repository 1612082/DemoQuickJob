...
class TabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
     ...
     func setupTabbar(){
               ...
               // xac dinh man hinh
               let Home = Main_Storyboard.instantiateViewController(withIdentifier: "HomeViewController") as! HomeViewController
               ...
               let Upload = Main_Storyboard.instantiateViewController(identifier: "UploadViewController") as! UploadViewController
               Upload.tabBarItem = UITabBarItem(title: "Upload", image: #imageLiteral(resourceName: "upload"), tag: 3000)
               ...
               let Profile = Main_Storyboard.instantiateViewController(withIdentifier: "ProfileViewController") as! ProfileViewController
