...
class TabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
     ...
     func setupTabbar(){
               ...
               Home.tabBarItem = UITabBarItem(title: "Trang chủ", image: #imageLiteral(resourceName: "home"), tag: 1000)
               ...
               Search.tabBarItem = UITabBarItem(title: "Tìm kiếm", image: #imageLiteral(resourceName: "search"), tag: 1000)
               ...
               Upload.tabBarItem = UITabBarItem(title: "Trò chuyện", image: #imageLiteral(resourceName: "mess"), tag: 3000)
               ...
               Manage.tabBarItem = UITabBarItem(title: "Quản lý", image: #imageLiteral(resourceName: "calendar"), tag: 1000)
               ...
               Profile.tabBarItem = UITabBarItem(title: "Cá nhân", image: #imageLiteral(resourceName: "user"), tag: 1000)
